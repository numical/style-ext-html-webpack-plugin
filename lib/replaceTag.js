...
const generateReplacementStyleTag = (cssFilename, compilation, minifier, attrs) => {
  let styleTag = {
    tagName: 'style',
    closeTag: true,
...
const replaceLinkTagWithStyleTag = (cssFilename, pluginArgs, compilation, minifier, attrs) => {
  const replacementTag = generateReplacementStyleTag(cssFilename, compilation, minifier, attrs);
